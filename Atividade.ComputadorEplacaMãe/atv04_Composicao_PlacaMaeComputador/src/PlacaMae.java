public class PlacaMae {
    ...
    public int getNumeroDeSlots() {return numeroDeSlots;}
    public void setNumeroDeSlots(int numeroDeSlots) {this.numeroDeSlots = numeroDeSlots;}
    public String getTipoDeMemoriaSuportada() {return tipoDeMemoriaSuportada;}
    public void setTipoDeMemoriaSuportada(String tipoDeMemoriaSuportada) {this.tipoDeMemoriaSuportada = tipoDeMemoriaSuportada;}
